...
<div className="equipo-carrusel">
  ...
  <div className="miembro">
    ...
    <small>Médico especialista en Medicina General y Familiar; Docente del Area de Simulación. — Facultad de Ciencias de la Salud (UNCPBA)</small>
  </div>
...
<div className="miembro">
    ...
    <small>Médico especialista en Medicina General y Familiar; y Emergentología; Docente del Area de Simulación. — Facultad de Ciencias de la Salud (UNCPBA)</small>
  </div>
